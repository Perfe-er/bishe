...
public class OtherMoralInfoActivity extends AppCompatActivity {
    private int userID;
    ImageView ivReturn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_other_moral_info);
        ...
        moralRefresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                initList();
                Toast.makeText(OtherMoralInfoActivity.this,"刷新成功",Toast.LENGTH_SHORT).show();
            }
        });
        initList();
    }
                ...
                .subscribe(new Observer<HttpResult<List<Moral>>>() {
                    ...
                    public void onNext(HttpResult<List<Moral>> listHttpResult) {
                        if (listHttpResult.getCode() == 200 && listHttpResult.getData() != null) {
                            ...
                            Toast.makeText(OtherMoralInfoActivity.this,"没有记录",Toast.LENGTH_SHORT).show();
                        }
                    }
