...
public class HeadManager {
    ...
    private String cosPathSplit = ".jpg"; //对象在存储桶中的位置标识符，即称对象键
    ...
    private static class Holder {
        private static HeadManager HeadManager = new HeadManager();
    }
    ...
    public static HeadManager getInstance() {
        return HeadManager.Holder.HeadManager;
    }
    ...
    public void uploadFile(String srcPath, String uid, CosXmlProgressListener progressListener, HeadManager.ICosXmlResultListener resultListener) {
        // 初始化 TransferConfig
