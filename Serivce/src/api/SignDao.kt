...
class SignDao : BaseDao() {
    ...
    suspend fun sign(call: ApplicationCall) {
        ...
        val uid: Int = request.queryParameters["uid"]?.toInt() ?: 0
        val signId: Int = request.queryParameters["signId"]?.toInt() ?: 0
        val signDate = request.queryParameters["signDate"]?.toLong() ?: 0
    ...
    suspend fun pubSign(call: ApplicationCall) {
        ...
        val request = call.request
        val originID: Int = request.queryParameters["originID"]?.toInt() ?: 0
        val iniDate: Long = request.queryParameters["iniDate"]?.toLong() ?: 0
        val endDate: Long = request.queryParameters["endDate"]?.toLong() ?: 0
        val signcol: String = request.queryParameters["signcol"] ?: ""
        val toClass: String = request.queryParameters["toClass"] ?: "" //接受班级　"1,2,4,6"
